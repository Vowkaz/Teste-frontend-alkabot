    ...
    return (
        <>
            <main className={`w-full lg:w-[calc(100dvw-5rem)] mx-0 lg:mx-auto h-max bg-gray-200 my-8 space-y-2 rounded-lg
                ...
                <p className={`px-8 py-4 text-xl lg:text-2xl border-b-2 border-gray-300`}>{post.title}</p>
                <p className={`px-8 h-fit py-4 text-xl lg:text-2xl text-gray-800/80`}>{post.body}</p>
